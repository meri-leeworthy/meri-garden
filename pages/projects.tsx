		...
		<div className="projects">
			...
			<section className="">
				...
				<div className="project-description">
					<p>
						The goal of Radical Directory is to build a community-run media platform for social and
						environmental justice activism.
					</p>
					<p>
						I got involved in May 2020 and took on the role of web developer. Since then I have been
						working to create an incredibly intuitive content creation experience for activists to
						share their projects, campaigns and events with each other and the world.
					</p>
					<p>
						In the process I have become experienced programming for a modern tech stack,
						particularly using React, Next.js, Typescript, GraphQL, Apollo, Prisma and Postgres.
					</p>
				</div>
				<div className="posts-container">{renderPosts(posts, "radical-directory")}</div>
			</section>
			...
			<section className="">
				...
				<div className="project-description">
					<p className="">
						Lorem ipsum dolor sit amet consectetur, adipisicing elit. Soluta vero saepe vitae
						blanditiis porro asperiores numquam? Odio earum praesentium, facilis dolores quo
						voluptatem qui id. Molestias alias quod veniam iusto.
					</p>
				</div>
